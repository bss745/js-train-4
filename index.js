...
function checkIfIncludes(mainStr, subStr) {
  ...
  const d = mainStr.includes(subStr);
  return d;
}
...
function findIndexOf(mainStr, subStr) {
  ...
  const e = mainStr.indexOf(subStr);
  return e;
}
...
function findLastIndexOf(mainStr, subStr) {
  ...
  const f = mainStr.lastIndexOf(subStr);
  return f;
}
...
function checkIfStartsWith(mainStr, subStr) {
  ...
  const g = mainStr.startsWith(subStr);
  return g;
}
...
function checkIfEndsWith(mainStr, subStr) {
  ...
  const h = mainStr.endsWith(subStr);
  return h;
}
...
function padString(original, length, padWith, side) {
  ...
  if (side === "start") {
    let paddedString = original.padStart(length, padWith);
    return paddedString;
  } else if (side === "end") {
    let paddedString = original.padEnd(length, padWith);
    return paddedString;
  } else {
...
function trimString(original, side) {
  ...
  if (side === "start") {
    return (original = original.trimStart());
  } else if (side === "end") {
...
function sliceString(string, startIndex, endIndex) {
  ...
  return (string = string.slice(startIndex, endIndex));
}
